...
import TopSection from './slider/TopSection';

const Home = () => {
  return (
    <>

      <TopSection title="Web security"
        localStorageKey="web-security"
        swiperClass="top_section" />

      <PostSlider title="new"
